  ...
  return (
    <div>
      ...
      <Routes>
          ...
          <Route path="sport" element={<News setProgress={this.setProgress}  pageSize={6} country="in" category="sport" />} />
          <Route path="technology" element={<News setProgress={this.setProgress}  pageSize={6} country="in" category="technology"></News>} />
        </Routes>
      </Router>
    </div>
  );
